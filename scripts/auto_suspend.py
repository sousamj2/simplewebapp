...
def update_db_before_suspend():
    ...
    try:
        ...
        remote_cmd = f"sudo python3 {remote_script} {remote_stats} --server-root /home/minecraft --with-rank --export-db /tmp/full_db_cache.txt && sudo cat /tmp/full_db_cache.txt"
